...
function LameJokes() {
    ...
    const jokes = [
        ...
        {prompt:"If supercalifragilisticexpialidocious is equal to one, and numGrapes is equal to one, which one is more? They are both equal, but one is misspelled.",
        id:7
    }
  ]
    ...
    return (
      <div className="App">
        ...
        <h3>Choose SHOW at your own risk...then feel free to hid it again LOL</h3>
          {
            jokes.map((item)=>(
              <ProgJoke
              key={item.id}
